...
mail = 'georgechen2@gmail.com';    %Your GMail email address
password = 'bkjgbjkyu1234';          %Your GMail password
% =========================================================================
...
%remove the 1 in the beginning of the number
...
switch strrep(strrep(lower(carrier),'-',''),'&','')
    ...
    case 'textnow';   emailto = strcat(number,'@textnow.me');   
end
